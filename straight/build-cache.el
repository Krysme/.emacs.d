...
(fn)" t) (add-to-list 'auto-mode-alist '("\\.toml\\'" . toml-mode)) (register-definition-prefixes "toml-mode" '("toml-mode-")) (provide 'toml-mode-autoloads)) "eros" ((eros-autoloads eros) (autoload 'eros-eval-last-sexp "eros" "Wrapper for `eval-last-sexp' that overlays results.
